...
export type LookupQuery = { __typename?: 'Query', main: (
    ...
    & { ' $fragmentRefs'?: { 'HeaderLookupFragment': HeaderLookupFragment;'OverviewLookupFragment': OverviewLookupFragment } }
