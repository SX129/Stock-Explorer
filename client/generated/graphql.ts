...
export type OverviewLookupFragment = { __typename?: 'Lookup', stats: { __typename?: 'StatsResult', marketCap: any, peRatioTtm: number, peRatioFwd: number, profitMarginPercent: number, freeCashFlowYield: number, dividendYield?: number | null } } & { ' $fragmentName'?: 'OverviewLookupFragment' };

export type SnapshotLookupFragment = { __typename?: 'Lookup', snapshotToday: { __typename?: 'SnapshotResult', changePercent: number }, snapshot1Year: { __typename?: 'SnapshotResult', changePercent: number }, snapshot5Year: { __typename?: 'SnapshotResult', changePercent: number, cagrPercent?: number | null }, snapshot10Year: { __typename?: 'SnapshotResult', changePercent: number, cagrPercent?: number | null } } & { ' $fragmentName'?: 'SnapshotLookupFragment' };

export type LookupQueryVariables = Exact<{ [key: string]: never; }>;


export type LookupQuery = { __typename?: 'Query', main: (
    { __typename?: 'Lookup', historicalTotalReturn: { __typename?: 'TotalReturnResult', changePercent: number, data: Array<{ __typename?: 'DataPoint', date: any, value: any }> }, revenue: Array<{ __typename?: 'DataPoint', date: any, value: any }> }
    & { ' $fragmentRefs'?: { 'HeaderLookupFragment': HeaderLookupFragment;'OverviewLookupFragment': OverviewLookupFragment;'SnapshotLookupFragment': SnapshotLookupFragment } }
